...
export const asignacionSchema = z.object({
  ...
  /** Fin de vigencia del enlace de entrega. */
  tokenVence: z.string(),
  /** Desde cuándo se puede confirmar la recepción: `inicio − minutos_vigencia_qr_antes`. */
  recepcionDesde: z.string(),
  /** Única cuenta que puede recibir. Nulo en registros históricos con QR genérico. */
  invitadoCorreo: z.string().nullable(),
  /** Dato histórico conservado para leer registros existentes. */
...
/** Datos de quien recibe, diligenciados una sola vez al recibir el espacio. */
...
/** Infraestructura registra una entrega ya coordinada con quien recibe. */
export const entregaInputSchema = nuevaAsignacionInputSchema.safeExtend({
  correoReceptor: correoInstitucional,
})
export type EntregaInput = z.infer<typeof entregaInputSchema>
