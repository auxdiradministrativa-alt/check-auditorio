...
3. Quien recibe diligencia **una sola vez, en el acta**, sus datos (rol, dependencia, cargo opc., celular, asistentes) y el **checklist** por elemento (`CONFORME`/`NOVEDAD`; cantidad en equipos/mobiliario; **foto obligatoria solo si hay novedad**; atajo «Todo en buen estado» que no pisa una novedad ya descrita) → condiciones del espacio → **términos + autorización** (casillas separadas, sin marcar) → envía.
